    ...
    return (
        <div className="login-box">
            ...
            <div className="login-box-right">
                ...
                <h2>Sign in</h2>
                <form method="POST" action="/login" className="login-box-form">
                    ...
                    <fieldset className="input-fieldset">
                        ...
                        <p className="errors-msg password-error"></p>
                    </div>

                    <button className="disabled" disabled={isDisabled} type="submit">Sign in</button>
                </form>

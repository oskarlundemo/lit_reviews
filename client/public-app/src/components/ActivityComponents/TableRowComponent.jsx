/**
 *
 * This component is used to create a row inside the TabelOfUsers.jsx table
 *
 * @param comment from a user
 * @param deleteComment function to delete that comment
 * @param bannedUsers list of banned users
 * @param openPopup state to openPopUp module
 * @returns {JSX.Element}
 * @constructor
 */
...
export const TableRowComponent = ({comment, deleteComment, bannedUsers, openPopup}) => {



    // Parse the created time from the db
    const parseTime = (createdAt) => {
        return createdAt.split('.')[0].replace('T', ' ');
    }
        ...
        <tr>
            ...
            <td>
                <div>
                    ...
                    <svg onClick={() => deleteComment(comment.id)} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                </div>
            </td>
        </tr>
    )
